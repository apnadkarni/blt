...
option add *Frame.background lightblue
option add *Toplevel.background lightblue

blt::bitmap define wide_weave { 
...
blt::bitmap compose top "Top\nScaled 2x" -pady 5 -padx 10 -rotate 0 -scale 2.0
blt::bitmap compose left "Left\na\nb\nc" -rotate 90
blt::bitmap compose right {Right} -rotate 270
blt::bitmap compose center {Center} -rotate 45 
blt::bitmap compose bottom {Bottom} -rotate 180
...
blt::bitmap define sharky [blt::bitmap data $bitmapFile]  -rotate 45 -scale 0.75
blt::bitmap define large_question [blt::bitmap data question]  -scale 2.0
blt::bitmap define large_questhead [blt::bitmap data questhead]  -scale 2.0
