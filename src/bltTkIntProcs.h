...
typedef struct BltTkIntProcs {
    ...
    Point2d (*blt_GetProjection2) (int x, int y, double x1, double y1, double x2, double y2); /* 23 */
    ...
    int (*blt_GetWindowRegion) (Display *display, Window window, int *xPtr, int *yPtr, int *widthPtr, int *heightPtr); /* 43 */
    ...
    Blt_DrawableAttributes * (*blt_GetDrawableAttribs) (Display *display, Drawable drawable); /* 48 */
    void (*blt_SetDrawableAttribs) (Display *display, Drawable drawable, int width, int height, int depth, Colormap colormap, Visual *visual); /* 49 */
    void (*blt_SetDrawableAttribsFromWindow) (Tk_Window tkwin, Drawable drawable); /* 50 */
    void (*blt_FreeDrawableAttribs) (Display *display, Drawable drawable); /* 51 */
    ...
    void (*blt_GetBoundingBox) (int width, int height, float angle, double *widthPtr, double *heightPtr, Point2d *points); /* 57 */
    Blt_Font (*blt_GetFont) (Tcl_Interp *interp, Tk_Window tkwin, const char *string); /* 58 */
    Blt_Font (*blt_AllocFontFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr); /* 59 */
    void (*blt_DrawWithEllipsis) (Tk_Window tkwin, Drawable drawable, GC gc, Blt_Font font, int depth, float angle, const char *string, int numBytes, int x, int y, int maxLength); /* 60 */
    Blt_Font (*blt_GetFontFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr); /* 61 */
    void (*blt_Font_GetMetrics) (Blt_Font font, Blt_FontMetrics *fmPtr); /* 62 */
    int (*blt_TextWidth) (Blt_Font font, const char *string, int length); /* 63 */
    Tcl_Interp * (*blt_Font_GetInterp) (Blt_Font font); /* 64 */
    Tcl_Obj * (*blt_Font_GetFile) (Tcl_Interp *interp, Tcl_Obj *objPtr, double *sizePtr); /* 65 */
    Blt_PaintBrush (*blt_NewTileBrush) (void); /* 66 */
    Blt_PaintBrush (*blt_NewLinearGradientBrush) (void); /* 67 */
    Blt_PaintBrush (*blt_NewStripeBrush) (void); /* 68 */
    Blt_PaintBrush (*blt_NewCheckerBrush) (void); /* 69 */
    Blt_PaintBrush (*blt_NewRadialGradientBrush) (void); /* 70 */
    Blt_PaintBrush (*blt_NewConicalGradientBrush) (void); /* 71 */
    Blt_PaintBrush (*blt_NewColorBrush) (unsigned int color); /* 72 */
    const char * (*blt_GetBrushType) (Blt_PaintBrush brush); /* 73 */
    const char * (*blt_GetBrushName) (Blt_PaintBrush brush); /* 74 */
    const char * (*blt_GetBrushColor) (Blt_PaintBrush brush); /* 75 */
    int (*blt_ConfigurePaintBrush) (Tcl_Interp *interp, Blt_PaintBrush brush); /* 76 */
    int (*blt_GetBrushTypeFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_PaintBrushType *typePtr); /* 77 */
    int (*blt_GetBrushAlpha) (Blt_PaintBrush brush); /* 78 */
    ...
    void (*blt_SetBrushRegion) (Blt_PaintBrush brush, int x, int y, int w, int h); /* 85 */
    void (*blt_SetTileBrushPicture) (Blt_PaintBrush brush, Blt_Picture tile); /* 86 */
    void (*blt_SetColorBrushColor) (Blt_PaintBrush brush, unsigned int value); /* 87 */
    void (*blt_SetBrushOrigin) (Blt_PaintBrush brush, int x, int y); /* 88 */
    void (*blt_GetBrushOrigin) (Blt_PaintBrush brush, int *xPtr, int *yPtr); /* 89 */
    int (*blt_GetAssociatedColorFromBrush) (Blt_PaintBrush brush, int x, int y); /* 90 */
    void (*blt_PaintRectangle) (Blt_Picture picture, int x, int y, int w, int h, int dx, int dy, Blt_PaintBrush brush); /* 91 */
    void (*blt_PaintPolygon) (Blt_Picture picture, int n, Point2f *vertices, Blt_PaintBrush brush); /* 92 */
    Blt_Bg (*blt_GetBg) (Tcl_Interp *interp, Tk_Window tkwin, const char *styleName); /* 93 */
    Blt_Bg (*blt_GetBgFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr); /* 94 */
    XColor * (*blt_Bg_BorderColor) (Blt_Bg bg); /* 95 */
    Tk_3DBorder (*blt_Bg_Border) (Blt_Bg bg); /* 96 */
    Blt_PaintBrush (*blt_Bg_PaintBrush) (Blt_Bg bg); /* 97 */
    const char * (*blt_Bg_Name) (Blt_Bg bg); /* 98 */
    void (*blt_FreeBg) (Blt_Bg bg); /* 99 */
    void (*blt_Bg_DrawRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 100 */
    void (*blt_Bg_FillRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 101 */
    void (*blt_Bg_DrawPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 102 */
    void (*blt_Bg_FillPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 103 */
    void (*blt_Bg_GetOrigin) (Blt_Bg bg, int *xPtr, int *yPtr); /* 104 */
    void (*blt_Bg_SetChangedProc) (Blt_Bg bg, Blt_Bg_ChangedProc *notifyProc, ClientData clientData); /* 105 */
    void (*blt_Bg_SetOrigin) (Tk_Window tkwin, Blt_Bg bg, int x, int y); /* 106 */
    void (*blt_Bg_DrawFocus) (Tk_Window tkwin, Blt_Bg bg, int highlightWidth, Drawable drawable); /* 107 */
    GC (*blt_Bg_BorderGC) (Tk_Window tkwin, Blt_Bg bg, int which); /* 108 */
    void (*blt_Bg_SetFromBackground) (Tk_Window tkwin, Blt_Bg bg); /* 109 */
    void (*blt_Bg_UnsetClipRegion) (Tk_Window tkwin, Blt_Bg bg); /* 110 */
    void (*blt_Bg_SetClipRegion) (Tk_Window tkwin, Blt_Bg bg, TkRegion rgn); /* 111 */
    unsigned int (*blt_Bg_GetColor) (Blt_Bg bg); /* 112 */
    void (*blt_DestroyBindingTable) (Blt_BindTable table); /* 113 */
    Blt_BindTable (*blt_CreateBindingTable) (Tcl_Interp *interp, Tk_Window tkwin, ClientData clientData, Blt_BindPickProc *pickProc, Blt_BindAppendTagsProc *tagProc); /* 114 */
    int (*blt_ConfigureBindings) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int argc, const char **argv); /* 115 */
    int (*blt_ConfigureBindingsFromObj) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int objc, Tcl_Obj *const *objv); /* 116 */
    void (*blt_PickCurrentItem) (Blt_BindTable table); /* 117 */
    void (*blt_DeleteBindings) (Blt_BindTable table, ClientData object); /* 118 */
    void (*blt_MoveBindingTable) (Blt_BindTable table, Tk_Window tkwin); /* 119 */
    void (*blt_Afm_SetPrinting) (Tcl_Interp *interp, int value); /* 120 */
    int (*blt_Afm_IsPrinting) (void); /* 121 */
    int (*blt_Afm_TextWidth) (Blt_Font font, const char *s, int numBytes); /* 122 */
    int (*blt_Afm_GetMetrics) (Blt_Font font, Blt_FontMetrics *fmPtr); /* 123 */
    const char * (*blt_Afm_GetPostscriptFamily) (const char *family); /* 124 */
    void (*blt_Afm_GetPostscriptName) (const char *family, int flags, Tcl_DString *resultPtr); /* 125 */
    void (*blt_SetDashes) (Display *display, GC gc, Blt_Dashes *dashesPtr); /* 126 */
    void (*blt_ResetLimits) (Blt_Limits *limitsPtr); /* 127 */
    int (*blt_GetLimitsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Limits *limitsPtr); /* 128 */
    int (*blt_ConfigureInfoFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 129 */
    int (*blt_ConfigureValueFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 130 */
    int (*blt_ConfigureWidgetFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 131 */
    int (*blt_ConfigureComponentFromObj) (Tcl_Interp *interp, Tk_Window tkwin, const char *name, const char *className, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 132 */
    int (*blt_ConfigModified) (Blt_ConfigSpec *specs, ...); /* 133 */
    const char * (*blt_NameOfState) (int state); /* 134 */
    void (*blt_FreeOptions) (Blt_ConfigSpec *specs, char *widgRec, Display *display, int needFlags); /* 135 */
    int (*blt_ObjIsOption) (Blt_ConfigSpec *specs, Tcl_Obj *objPtr, int flags); /* 136 */
    int (*blt_GetPixelsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, int flags, int *valuePtr); /* 137 */
    int (*blt_GetPadFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Pad *padPtr); /* 138 */
    int (*blt_GetStateFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *statePtr); /* 139 */
    int (*blt_GetFillFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 140 */
    int (*blt_GetResizeFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 141 */
    int (*blt_GetDashesFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_Dashes *dashesPtr); /* 142 */
    int (*blt_Image_IsDeleted) (Tk_Image tkImage); /* 143 */
    Tk_ImageMaster (*blt_Image_GetMaster) (Tk_Image tkImage); /* 144 */
    Tk_ImageType * (*blt_Image_GetType) (Tk_Image tkImage); /* 145 */
    ClientData (*blt_Image_GetInstanceData) (Tk_Image tkImage); /* 146 */
    const char * (*blt_Image_Name) (Tk_Image tkImage); /* 147 */
    const char * (*blt_Image_NameOfType) (Tk_Image tkImage); /* 148 */
    void (*blt_FreePainter) (Blt_Painter painter); /* 149 */
    Blt_Painter (*blt_GetPainter) (Tk_Window tkwin, float gamma); /* 150 */
    Blt_Painter (*blt_GetPainterFromDrawable) (Display *display, Drawable drawable, float gamma); /* 151 */
    GC (*blt_PainterGC) (Blt_Painter painter); /* 152 */
    int (*blt_PainterDepth) (Blt_Painter painter); /* 153 */
    int (*blt_PaintPicture) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 154 */
    int (*blt_PaintPictureWithBlend) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 155 */
    Blt_Picture (*blt_PaintCheckbox) (int width, int height, XColor *fillColor, XColor *outlineColor, XColor *checkColor, int isOn); /* 156 */
    Blt_Picture (*blt_PaintRadioButton) (int width, int height, Blt_Bg bg, XColor *fill, XColor *outline, int isOn); /* 157 */
    Blt_Picture (*blt_PaintRadioButtonOld) (int width, int height, XColor *bg, XColor *fill, XColor *outline, XColor *check, int isOn); /* 158 */
    Blt_Picture (*blt_PaintDelete) (int width, int height, XColor *bgColor, XColor *fillColor, XColor *symColor, int isActive); /* 159 */
    Blt_Ps (*blt_Ps_Create) (Tcl_Interp *interp, PageSetup *setupPtr); /* 160 */
    void (*blt_Ps_Free) (Blt_Ps ps); /* 161 */
    const char * (*blt_Ps_GetValue) (Blt_Ps ps, int *lengthPtr); /* 162 */
    Blt_DBuffer (*blt_Ps_GetDBuffer) (Blt_Ps ps); /* 163 */
    Tcl_Interp * (*blt_Ps_GetInterp) (Blt_Ps ps); /* 164 */
    char * (*blt_Ps_GetScratchBuffer) (Blt_Ps ps); /* 165 */
    void (*blt_Ps_SetInterp) (Blt_Ps ps, Tcl_Interp *interp); /* 166 */
    void (*blt_Ps_Append) (Blt_Ps ps, const char *string); /* 167 */
    void (*blt_Ps_AppendBytes) (Blt_Ps ps, const char *string, int numBytes); /* 168 */
    void (*blt_Ps_VarAppend) (Blt_Ps ps, ...); /* 169 */
    void (*blt_Ps_Format) (Blt_Ps ps, const char *fmt, ...); /* 170 */
    void (*blt_Ps_SetClearBackground) (Blt_Ps ps); /* 171 */
    int (*blt_Ps_IncludeFile) (Tcl_Interp *interp, Blt_Ps ps, const char *fileName); /* 172 */
    int (*blt_Ps_GetPicaFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *picaPtr); /* 173 */
    int (*blt_Ps_GetPadFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_Pad *padPtr); /* 174 */
    int (*blt_Ps_ComputeBoundingBox) (PageSetup *setupPtr, int w, int h); /* 175 */
    void (*blt_Ps_DrawPicture) (Blt_Ps ps, Blt_Picture picture, double x, double y); /* 176 */
    void (*blt_Ps_Rectangle) (Blt_Ps ps, int x, int y, int w, int h); /* 177 */
    int (*blt_Ps_SaveFile) (Tcl_Interp *interp, Blt_Ps ps, const char *fileName); /* 178 */
    void (*blt_Ps_XSetLineWidth) (Blt_Ps ps, int lineWidth); /* 179 */
    void (*blt_Ps_XSetBackground) (Blt_Ps ps, XColor *colorPtr); /* 180 */
    void (*blt_Ps_XSetBitmapData) (Blt_Ps ps, Display *display, Pixmap bitmap, int width, int height); /* 181 */
    void (*blt_Ps_XSetForeground) (Blt_Ps ps, XColor *colorPtr); /* 182 */
    void (*blt_Ps_XSetFont) (Blt_Ps ps, Blt_Font font); /* 183 */
    void (*blt_Ps_XSetDashes) (Blt_Ps ps, Blt_Dashes *dashesPtr); /* 184 */
    void (*blt_Ps_XSetLineAttributes) (Blt_Ps ps, XColor *colorPtr, int lineWidth, Blt_Dashes *dashesPtr, int capStyle, int joinStyle); /* 185 */
    void (*blt_Ps_XSetStipple) (Blt_Ps ps, Display *display, Pixmap bitmap); /* 186 */
    void (*blt_Ps_Polyline) (Blt_Ps ps, int n, Point2d *points); /* 187 */
    void (*blt_Ps_XDrawLines) (Blt_Ps ps, int n, XPoint *points); /* 188 */
    void (*blt_Ps_XDrawSegments) (Blt_Ps ps, int n, XSegment *segments); /* 189 */
    void (*blt_Ps_DrawPolyline) (Blt_Ps ps, int n, Point2d *points); /* 190 */
    void (*blt_Ps_DrawSegments2d) (Blt_Ps ps, int n, Segment2d *segments); /* 191 */
    void (*blt_Ps_Draw3DRectangle) (Blt_Ps ps, Tk_3DBorder border, double x, double y, int width, int height, int borderWidth, int relief); /* 192 */
    void (*blt_Ps_Fill3DRectangle) (Blt_Ps ps, Tk_3DBorder border, double x, double y, int width, int height, int borderWidth, int relief); /* 193 */
    void (*blt_Ps_XFillRectangle) (Blt_Ps ps, double x, double y, int width, int height); /* 194 */
    void (*blt_Ps_XFillRectangles) (Blt_Ps ps, int n, XRectangle *rects); /* 195 */
    void (*blt_Ps_XFillPolygon) (Blt_Ps ps, int n, Point2d *points); /* 196 */
    void (*blt_Ps_DrawPhoto) (Blt_Ps ps, Tk_PhotoHandle photoToken, double x, double y); /* 197 */
    void (*blt_Ps_XDrawWindow) (Blt_Ps ps, Tk_Window tkwin, double x, double y); /* 198 */
    void (*blt_Ps_DrawText) (Blt_Ps ps, const char *string, TextStyle *attrPtr, double x, double y); /* 199 */
    void (*blt_Ps_DrawBitmap) (Blt_Ps ps, Display *display, Pixmap bitmap, double scaleX, double scaleY); /* 200 */
    void (*blt_Ps_XSetCapStyle) (Blt_Ps ps, int capStyle); /* 201 */
    void (*blt_Ps_XSetJoinStyle) (Blt_Ps ps, int joinStyle); /* 202 */
    void (*blt_Ps_PolylineFromXPoints) (Blt_Ps ps, int n, XPoint *points); /* 203 */
    void (*blt_Ps_Polygon) (Blt_Ps ps, Point2d *points, int numPoints); /* 204 */
    void (*blt_Ps_SetPrinting) (Blt_Ps ps, int value); /* 205 */
    TextLayout * (*blt_Ts_CreateLayout) (const char *string, int length, TextStyle *tsPtr); /* 206 */
    TextLayout * (*blt_Ts_TitleLayout) (const char *string, int length, TextStyle *tsPtr); /* 207 */
    void (*blt_Ts_DrawLayout) (Tk_Window tkwin, Drawable drawable, TextLayout *textPtr, TextStyle *tsPtr, int x, int y); /* 208 */
    void (*blt_Ts_GetExtents) (TextStyle *tsPtr, const char *text, unsigned int *widthPtr, unsigned int *heightPtr); /* 209 */
    void (*blt_Ts_ResetStyle) (Tk_Window tkwin, TextStyle *tsPtr); /* 210 */
    void (*blt_Ts_FreeStyle) (Display *display, TextStyle *tsPtr); /* 211 */
    void (*blt_Ts_SetDrawStyle) (TextStyle *tsPtr, Blt_Font font, GC gc, XColor *fgColor, float angle, Tk_Anchor anchor, Tk_Justify justify, int leader); /* 212 */
    void (*blt_DrawText) (Tk_Window tkwin, Drawable drawable, const char *string, TextStyle *tsPtr, int x, int y); /* 213 */
    void (*blt_DrawText2) (Tk_Window tkwin, Drawable drawable, const char *string, TextStyle *tsPtr, int x, int y, Dim2d *dimPtr); /* 214 */
    Pixmap (*blt_Ts_Bitmap) (Tk_Window tkwin, TextLayout *textPtr, TextStyle *tsPtr, int *widthPtr, int *heightPtr); /* 215 */
    int (*blt_DrawTextWithRotatedFont) (Tk_Window tkwin, Drawable drawable, float angle, TextStyle *tsPtr, TextLayout *textPtr, int x, int y); /* 216 */
    void (*blt_DrawLayout) (Tk_Window tkwin, Drawable drawable, GC gc, Blt_Font font, int depth, float angle, int x, int y, TextLayout *layoutPtr, int maxLength); /* 217 */
    void (*blt_GetTextExtents) (Blt_Font font, int leader, const char *text, int textLen, unsigned int *widthPtr, unsigned int *heightPtr); /* 218 */
    void (*blt_RotateStartingTextPositions) (TextLayout *textPtr, float angle); /* 219 */
    Tk_TextLayout (*blt_ComputeTextLayout) (Blt_Font font, const char *string, int numChars, int wrapLength, Tk_Justify justify, int flags, int *widthPtr, int *heightPtr); /* 220 */
    void (*blt_DrawTextLayout) (Display *display, Drawable drawable, GC gc, Tk_TextLayout layout, int x, int y, int firstChar, int lastChar); /* 221 */
    int (*blt_CharBbox) (Tk_TextLayout layout, int index, int *xPtr, int *yPtr, int *widthPtr, int *heightPtr); /* 222 */
    void (*blt_UnderlineTextLayout) (Display *display, Drawable drawable, GC gc, Tk_TextLayout layout, int x, int y, int underline); /* 223 */
    void (*blt_Ts_UnderlineLayout) (Tk_Window tkwin, Drawable drawable, TextLayout *layoutPtr, TextStyle *tsPtr, int x, int y); /* 224 */
    void (*blt_Ts_DrawText) (Tk_Window tkwin, Drawable drawable, const char *text, int textLen, TextStyle *tsPtr, int x, int y); /* 225 */
    int (*blt_MeasureText) (Blt_Font font, const char *text, int textLen, int maxLength, int *nBytesPtr); /* 226 */
    void (*blt_FreeTextLayout) (Tk_TextLayout layout); /* 227 */
} BltTkIntProcs;
...
#define Blt_GetProjection2 \
	(bltTkIntProcsPtr->blt_GetProjection2) /* 23 */
#endif
...
#define Blt_GetWindowRegion \
	(bltTkIntProcsPtr->blt_GetWindowRegion) /* 43 */
#endif
...
#define Blt_FreeTextLayout \
	(bltTkIntProcsPtr->blt_FreeTextLayout) /* 227 */
#endif
