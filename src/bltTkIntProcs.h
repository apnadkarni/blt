...
#endif
#ifndef Blt_GetChildWindows_DECLARED
#define Blt_GetChildWindows_DECLARED
/* 12 */
...
typedef struct BltTkIntProcs {
    ...
    Blt_Chain (*blt_GetChildWindows) (Display *display, Window window); /* 12 */
    ...
    const char * (*blt_NameOfFill) (int fill); /* 20 */
    const char * (*blt_NameOfResize) (int resize); /* 21 */
    int (*blt_GetXY) (Tcl_Interp *interp, Tk_Window tkwin, const char *string, int *xPtr, int *yPtr); /* 22 */
    Point2d (*blt_GetProjection) (int x, int y, Point2d *p, Point2d *q); /* 23 */
    Point2d (*blt_GetProjection2) (int x, int y, double x1, double y1, double x2, double y2); /* 24 */
    void (*blt_DrawArrowOld) (Display *display, Drawable drawable, GC gc, int x, int y, int w, int h, int borderWidth, int orientation); /* 25 */
    void (*blt_DrawArrow) (Display *display, Drawable drawable, XColor *color, int x, int y, int w, int h, int borderWidth, int orientation); /* 26 */
    void (*blt_MakeTransparentWindowExist) (Tk_Window tkwin, Window parent, int isBusy); /* 27 */
    void (*blt_TranslateAnchor) (int x, int y, int width, int height, Tk_Anchor anchor, int *transXPtr, int *transYPtr); /* 28 */
    Point2d (*blt_AnchorPoint) (double x, double y, double width, double height, Tk_Anchor anchor); /* 29 */
    long (*blt_MaxRequestSize) (Display *display, size_t elemSize); /* 30 */
    Window (*blt_GetWindowId) (Tk_Window tkwin); /* 31 */
    void (*blt_InitXRandrConfig) (Tcl_Interp *interp); /* 32 */
    void (*blt_SizeOfScreen) (Tk_Window tkwin, int *widthPtr, int *heightPtr); /* 33 */
    int (*blt_RootX) (Tk_Window tkwin); /* 34 */
    int (*blt_RootY) (Tk_Window tkwin); /* 35 */
    void (*blt_RootCoordinates) (Tk_Window tkwin, int x, int y, int *rootXPtr, int *rootYPtr); /* 36 */
    void (*blt_MapToplevelWindow) (Tk_Window tkwin); /* 37 */
    void (*blt_UnmapToplevelWindow) (Tk_Window tkwin); /* 38 */
    void (*blt_RaiseToplevelWindow) (Tk_Window tkwin); /* 39 */
    void (*blt_LowerToplevelWindow) (Tk_Window tkwin); /* 40 */
    void (*blt_ResizeToplevelWindow) (Tk_Window tkwin, int w, int h); /* 41 */
    void (*blt_MoveToplevelWindow) (Tk_Window tkwin, int x, int y); /* 42 */
    void (*blt_MoveResizeToplevelWindow) (Tk_Window tkwin, int x, int y, int w, int h); /* 43 */
    int (*blt_GetWindowRegion) (Display *display, Window window, int *xPtr, int *yPtr, int *widthPtr, int *heightPtr); /* 44 */
    ClientData (*blt_GetWindowInstanceData) (Tk_Window tkwin); /* 45 */
    void (*blt_SetWindowInstanceData) (Tk_Window tkwin, ClientData instanceData); /* 46 */
    void (*blt_DeleteWindowInstanceData) (Tk_Window tkwin); /* 47 */
    int (*blt_ReparentWindow) (Display *display, Window window, Window newParent, int x, int y); /* 48 */
    Blt_DrawableAttributes * (*blt_GetDrawableAttribs) (Display *display, Drawable drawable); /* 49 */
    void (*blt_SetDrawableAttribs) (Display *display, Drawable drawable, int width, int height, int depth, Colormap colormap, Visual *visual); /* 50 */
    void (*blt_SetDrawableAttribsFromWindow) (Tk_Window tkwin, Drawable drawable); /* 51 */
    void (*blt_FreeDrawableAttribs) (Display *display, Drawable drawable); /* 52 */
    GC (*blt_GetBitmapGC) (Tk_Window tkwin); /* 53 */
    Pixmap (*blt_GetPixmapAbortOnError) (Display *dpy, Drawable draw, int w, int h, int depth, int lineNum, const char *fileName); /* 54 */
    void (*blt_ScreenDPI) (Tk_Window tkwin, int *xPtr, int *yPtr); /* 55 */
    int (*blt_OldConfigModified) (Tk_ConfigSpec *specs, ...); /* 56 */
    void (*blt_GetLineExtents) (size_t numPoints, Point2d *points, Region2d *r); /* 57 */
    void (*blt_GetBoundingBox) (int width, int height, float angle, double *widthPtr, double *heightPtr, Point2d *points); /* 58 */
    ...
    Blt_PaintBrush (*blt_NewStripeBrush) (void); /* 69 */
    Blt_PaintBrush (*blt_NewCheckerBrush) (void); /* 70 */
    ...
    const char * (*blt_GetBrushType) (Blt_PaintBrush brush); /* 74 */
    const char * (*blt_GetBrushName) (Blt_PaintBrush brush); /* 75 */
    const char * (*blt_GetBrushColor) (Blt_PaintBrush brush); /* 76 */
    ...
    void (*blt_SetBrushRegion) (Blt_PaintBrush brush, int x, int y, int w, int h); /* 89 */
    int (*blt_GetBrushAlpha) (Blt_PaintBrush brush); /* 90 */
    void (*blt_GetBrushOrigin) (Blt_PaintBrush brush, int *xPtr, int *yPtr); /* 91 */
    int (*blt_GetAssociatedColorFromBrush) (Blt_PaintBrush brush, int x, int y); /* 92 */
    void (*blt_PaintRectangle) (Blt_Picture picture, int x, int y, int w, int h, int dx, int dy, Blt_PaintBrush brush); /* 93 */
    void (*blt_PaintPolygon) (Blt_Picture picture, int n, Point2f *vertices, Blt_PaintBrush brush); /* 94 */
    void (*blt_CreateBrushNotifier) (Blt_PaintBrush brush, Blt_BrushChangedProc *notifyProc, ClientData clientData); /* 95 */
    void (*blt_DeleteBrushNotifier) (Blt_PaintBrush brush, Blt_BrushChangedProc *notifyProc, ClientData clientData); /* 96 */
    int (*blt_GetBg) (Tcl_Interp *interp, Tk_Window tkwin, const char *bgName, Blt_Bg *bgPtr); /* 97 */
    int (*blt_GetBgFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Bg *bgPtr); /* 98 */
    XColor * (*blt_Bg_BorderColor) (Blt_Bg bg); /* 99 */
    Tk_3DBorder (*blt_Bg_Border) (Blt_Bg bg); /* 100 */
    Blt_PaintBrush (*blt_Bg_PaintBrush) (Blt_Bg bg); /* 101 */
    const char * (*blt_Bg_Name) (Blt_Bg bg); /* 102 */
    void (*blt_Bg_Free) (Blt_Bg bg); /* 103 */
    void (*blt_Bg_DrawRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 104 */
    void (*blt_Bg_FillRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 105 */
    void (*blt_Bg_DrawPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 106 */
    void (*blt_Bg_FillPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 107 */
    void (*blt_Bg_GetOrigin) (Blt_Bg bg, int *xPtr, int *yPtr); /* 108 */
    void (*blt_Bg_SetChangedProc) (Blt_Bg bg, Blt_BackgroundChangedProc *notifyProc, ClientData clientData); /* 109 */
    void (*blt_Bg_SetOrigin) (Tk_Window tkwin, Blt_Bg bg, int x, int y); /* 110 */
    void (*blt_Bg_DrawFocus) (Tk_Window tkwin, Blt_Bg bg, int highlightWidth, Drawable drawable); /* 111 */
    GC (*blt_Bg_BorderGC) (Tk_Window tkwin, Blt_Bg bg, int which); /* 112 */
    void (*blt_Bg_SetFromBackground) (Tk_Window tkwin, Blt_Bg bg); /* 113 */
    void (*blt_Bg_UnsetClipRegion) (Tk_Window tkwin, Blt_Bg bg); /* 114 */
    void (*blt_Bg_SetClipRegion) (Tk_Window tkwin, Blt_Bg bg, TkRegion rgn); /* 115 */
    unsigned int (*blt_Bg_GetColor) (Blt_Bg bg); /* 116 */
    void (*blt_3DBorder_SetClipRegion) (Tk_Window tkwin, Tk_3DBorder border, TkRegion rgn); /* 117 */
    void (*blt_3DBorder_UnsetClipRegion) (Tk_Window tkwin, Tk_3DBorder border); /* 118 */
    void (*blt_DestroyBindingTable) (Blt_BindTable table); /* 119 */
    Blt_BindTable (*blt_CreateBindingTable) (Tcl_Interp *interp, Tk_Window tkwin, ClientData clientData, Blt_BindPickProc *pickProc, Blt_BindAppendTagsProc *tagProc); /* 120 */
    int (*blt_ConfigureBindings) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int argc, const char **argv); /* 121 */
    int (*blt_ConfigureBindingsFromObj) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int objc, Tcl_Obj *const *objv); /* 122 */
    void (*blt_PickCurrentItem) (Blt_BindTable table); /* 123 */
    void (*blt_DeleteBindings) (Blt_BindTable table, ClientData object); /* 124 */
    void (*blt_MoveBindingTable) (Blt_BindTable table, Tk_Window tkwin); /* 125 */
    void (*blt_Afm_SetPrinting) (Tcl_Interp *interp, int value); /* 126 */
    int (*blt_Afm_IsPrinting) (void); /* 127 */
    int (*blt_Afm_TextWidth) (Blt_Font font, const char *s, int numBytes); /* 128 */
    int (*blt_Afm_GetMetrics) (Blt_Font font, Blt_FontMetrics *fmPtr); /* 129 */
    const char * (*blt_Afm_GetPostscriptFamily) (const char *family); /* 130 */
    void (*blt_Afm_GetPostscriptName) (const char *family, int flags, Tcl_DString *resultPtr); /* 131 */
    void (*blt_SetDashes) (Display *display, GC gc, Blt_Dashes *dashesPtr); /* 132 */
    void (*blt_ResetLimits) (Blt_Limits *limitsPtr); /* 133 */
    int (*blt_GetLimitsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Limits *limitsPtr); /* 134 */
    int (*blt_ConfigureInfoFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 135 */
    int (*blt_ConfigureValueFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 136 */
    int (*blt_ConfigureWidgetFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 137 */
    int (*blt_ConfigureComponentFromObj) (Tcl_Interp *interp, Tk_Window tkwin, const char *name, const char *className, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 138 */
    int (*blt_ConfigModified) (Blt_ConfigSpec *specs, ...); /* 139 */
    const char * (*blt_NameOfState) (int state); /* 140 */
    void (*blt_FreeOptions) (Blt_ConfigSpec *specs, char *widgRec, Display *display, int needFlags); /* 141 */
    int (*blt_ObjIsOption) (Blt_ConfigSpec *specs, Tcl_Obj *objPtr, int flags); /* 142 */
    int (*blt_GetPixelsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, int flags, int *valuePtr); /* 143 */
    int (*blt_GetPadFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Pad *padPtr); /* 144 */
    int (*blt_GetStateFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *statePtr); /* 145 */
    int (*blt_GetFillFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 146 */
    int (*blt_GetResizeFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 147 */
    int (*blt_GetDashesFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_Dashes *dashesPtr); /* 148 */
    int (*blt_Image_IsDeleted) (Tk_Image tkImage); /* 149 */
    Tk_ImageMaster (*blt_Image_GetMaster) (Tk_Image tkImage); /* 150 */
    Tk_ImageType * (*blt_Image_GetType) (Tk_Image tkImage); /* 151 */
    ClientData (*blt_Image_GetInstanceData) (Tk_Image tkImage); /* 152 */
    const char * (*blt_Image_Name) (Tk_Image tkImage); /* 153 */
    const char * (*blt_Image_NameOfType) (Tk_Image tkImage); /* 154 */
    void (*blt_FreePainter) (Blt_Painter painter); /* 155 */
    Blt_Painter (*blt_GetPainter) (Tk_Window tkwin, float gamma); /* 156 */
    Blt_Painter (*blt_GetPainterFromDrawable) (Display *display, Drawable drawable, float gamma); /* 157 */
    GC (*blt_PainterGC) (Blt_Painter painter); /* 158 */
    int (*blt_PainterDepth) (Blt_Painter painter); /* 159 */
    void (*blt_SetPainterClipRegion) (Blt_Painter painter, TkRegion rgn); /* 160 */
    void (*blt_UnsetPainterClipRegion) (Blt_Painter painter); /* 161 */
    int (*blt_PaintPicture) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 162 */
    int (*blt_PaintPictureWithBlend) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 163 */
    Blt_Picture (*blt_PaintCheckbox) (int width, int height, XColor *fillColor, XColor *outlineColor, XColor *checkColor, int isOn); /* 164 */
    Blt_Picture (*blt_PaintRadioButton) (int width, int height, Blt_Bg bg, XColor *fill, XColor *outline, int isOn); /* 165 */
    Blt_Picture (*blt_PaintRadioButtonOld) (int width, int height, XColor *bg, XColor *fill, XColor *outline, XColor *check, int isOn); /* 166 */
    Blt_Picture (*blt_PaintDelete) (int width, int height, XColor *bgColor, XColor *fillColor, XColor *symColor, int isActive); /* 167 */
    Blt_Ps (*blt_Ps_Create) (Tcl_Interp *interp, PageSetup *setupPtr); /* 168 */
    void (*blt_Ps_Free) (Blt_Ps ps); /* 169 */
    const char * (*blt_Ps_GetValue) (Blt_Ps ps, int *lengthPtr); /* 170 */
    Blt_DBuffer (*blt_Ps_GetDBuffer) (Blt_Ps ps); /* 171 */
    Tcl_Interp * (*blt_Ps_GetInterp) (Blt_Ps ps); /* 172 */
    char * (*blt_Ps_GetScratchBuffer) (Blt_Ps ps); /* 173 */
    void (*blt_Ps_SetInterp) (Blt_Ps ps, Tcl_Interp *interp); /* 174 */
    void (*blt_Ps_Append) (Blt_Ps ps, const char *string); /* 175 */
    void (*blt_Ps_AppendBytes) (Blt_Ps ps, const char *string, int numBytes); /* 176 */
    void (*blt_Ps_VarAppend) (Blt_Ps ps, ...); /* 177 */
    void (*blt_Ps_Format) (Blt_Ps ps, const char *fmt, ...); /* 178 */
    void (*blt_Ps_SetClearBackground) (Blt_Ps ps); /* 179 */
    int (*blt_Ps_IncludeFile) (Tcl_Interp *interp, Blt_Ps ps, const char *fileName); /* 180 */
    int (*blt_Ps_GetPicaFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *picaPtr); /* 181 */
    int (*blt_Ps_GetPadFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_Pad *padPtr); /* 182 */
    int (*blt_Ps_ComputeBoundingBox) (PageSetup *setupPtr, int w, int h); /* 183 */
    void (*blt_Ps_DrawPicture) (Blt_Ps ps, Blt_Picture picture, double x, double y); /* 184 */
    void (*blt_Ps_Rectangle) (Blt_Ps ps, int x, int y, int w, int h); /* 185 */
    int (*blt_Ps_SaveFile) (Tcl_Interp *interp, Blt_Ps ps, const char *fileName); /* 186 */
    void (*blt_Ps_XSetLineWidth) (Blt_Ps ps, int lineWidth); /* 187 */
    void (*blt_Ps_XSetBackground) (Blt_Ps ps, XColor *colorPtr); /* 188 */
    void (*blt_Ps_XSetBitmapData) (Blt_Ps ps, Display *display, Pixmap bitmap, int width, int height); /* 189 */
    void (*blt_Ps_XSetForeground) (Blt_Ps ps, XColor *colorPtr); /* 190 */
    void (*blt_Ps_XSetFont) (Blt_Ps ps, Blt_Font font); /* 191 */
    void (*blt_Ps_XSetDashes) (Blt_Ps ps, Blt_Dashes *dashesPtr); /* 192 */
    void (*blt_Ps_XSetLineAttributes) (Blt_Ps ps, XColor *colorPtr, int lineWidth, Blt_Dashes *dashesPtr, int capStyle, int joinStyle); /* 193 */
    void (*blt_Ps_XSetStipple) (Blt_Ps ps, Display *display, Pixmap bitmap); /* 194 */
    void (*blt_Ps_Polyline) (Blt_Ps ps, int n, Point2d *points); /* 195 */
    void (*blt_Ps_XDrawLines) (Blt_Ps ps, int n, XPoint *points); /* 196 */
    void (*blt_Ps_XDrawSegments) (Blt_Ps ps, int n, XSegment *segments); /* 197 */
    void (*blt_Ps_DrawPolyline) (Blt_Ps ps, int n, Point2d *points); /* 198 */
    void (*blt_Ps_DrawSegments2d) (Blt_Ps ps, int n, Segment2d *segments); /* 199 */
    void (*blt_Ps_Draw3DRectangle) (Blt_Ps ps, Tk_3DBorder border, double x, double y, int width, int height, int borderWidth, int relief); /* 200 */
    void (*blt_Ps_Fill3DRectangle) (Blt_Ps ps, Tk_3DBorder border, double x, double y, int width, int height, int borderWidth, int relief); /* 201 */
    void (*blt_Ps_XFillRectangle) (Blt_Ps ps, double x, double y, int width, int height); /* 202 */
    void (*blt_Ps_XFillRectangles) (Blt_Ps ps, int n, XRectangle *rects); /* 203 */
    void (*blt_Ps_XFillPolygon) (Blt_Ps ps, int n, Point2d *points); /* 204 */
    void (*blt_Ps_DrawPhoto) (Blt_Ps ps, Tk_PhotoHandle photoToken, double x, double y); /* 205 */
    void (*blt_Ps_XDrawWindow) (Blt_Ps ps, Tk_Window tkwin, double x, double y); /* 206 */
    void (*blt_Ps_DrawText) (Blt_Ps ps, const char *string, TextStyle *attrPtr, double x, double y); /* 207 */
    void (*blt_Ps_DrawBitmap) (Blt_Ps ps, Display *display, Pixmap bitmap, double scaleX, double scaleY); /* 208 */
    void (*blt_Ps_XSetCapStyle) (Blt_Ps ps, int capStyle); /* 209 */
    void (*blt_Ps_XSetJoinStyle) (Blt_Ps ps, int joinStyle); /* 210 */
    void (*blt_Ps_PolylineFromXPoints) (Blt_Ps ps, int n, XPoint *points); /* 211 */
    void (*blt_Ps_Polygon) (Blt_Ps ps, Point2d *points, int numPoints); /* 212 */
    void (*blt_Ps_SetPrinting) (Blt_Ps ps, int value); /* 213 */
    TextLayout * (*blt_Ts_CreateLayout) (const char *string, int length, TextStyle *tsPtr); /* 214 */
    TextLayout * (*blt_Ts_TitleLayout) (const char *string, int length, TextStyle *tsPtr); /* 215 */
    void (*blt_Ts_DrawLayout) (Tk_Window tkwin, Drawable drawable, TextLayout *textPtr, TextStyle *tsPtr, int x, int y); /* 216 */
    void (*blt_Ts_GetExtents) (TextStyle *tsPtr, const char *text, unsigned int *widthPtr, unsigned int *heightPtr); /* 217 */
    void (*blt_Ts_ResetStyle) (Tk_Window tkwin, TextStyle *tsPtr); /* 218 */
    void (*blt_Ts_FreeStyle) (Display *display, TextStyle *tsPtr); /* 219 */
    void (*blt_Ts_SetDrawStyle) (TextStyle *tsPtr, Blt_Font font, GC gc, XColor *fgColor, float angle, Tk_Anchor anchor, Tk_Justify justify, int leader); /* 220 */
    ...
    Pixmap (*blt_Ts_Bitmap) (Tk_Window tkwin, TextLayout *textPtr, TextStyle *tsPtr, int *widthPtr, int *heightPtr); /* 223 */
    int (*blt_DrawTextWithRotatedFont) (Tk_Window tkwin, Drawable drawable, float angle, TextStyle *tsPtr, TextLayout *textPtr, int x, int y); /* 224 */
    void (*blt_DrawLayout) (Tk_Window tkwin, Drawable drawable, GC gc, Blt_Font font, int depth, float angle, int x, int y, TextLayout *layoutPtr, int maxLength); /* 225 */
    void (*blt_GetTextExtents) (Blt_Font font, int leader, const char *text, int textLen, unsigned int *widthPtr, unsigned int *heightPtr); /* 226 */
    void (*blt_RotateStartingTextPositions) (TextLayout *textPtr, float angle); /* 227 */
    Tk_TextLayout (*blt_ComputeTextLayout) (Blt_Font font, const char *string, int numChars, int wrapLength, Tk_Justify justify, int flags, int *widthPtr, int *heightPtr); /* 228 */
    void (*blt_DrawTextLayout) (Display *display, Drawable drawable, GC gc, Tk_TextLayout layout, int x, int y, int firstChar, int lastChar); /* 229 */
    int (*blt_CharBbox) (Tk_TextLayout layout, int index, int *xPtr, int *yPtr, int *widthPtr, int *heightPtr); /* 230 */
    void (*blt_UnderlineTextLayout) (Display *display, Drawable drawable, GC gc, Tk_TextLayout layout, int x, int y, int underline); /* 231 */
    void (*blt_Ts_UnderlineLayout) (Tk_Window tkwin, Drawable drawable, TextLayout *layoutPtr, TextStyle *tsPtr, int x, int y); /* 232 */
    void (*blt_Ts_DrawText) (Tk_Window tkwin, Drawable drawable, const char *text, int textLen, TextStyle *tsPtr, int x, int y); /* 233 */
    int (*blt_MeasureText) (Blt_Font font, const char *text, int textLen, int maxLength, int *nBytesPtr); /* 234 */
    void (*blt_FreeTextLayout) (Tk_TextLayout layout); /* 235 */
} BltTkIntProcs;
...
#endif
#ifndef Blt_GetChildWindows
#define Blt_GetChildWindows \
	(bltTkIntProcsPtr->blt_GetChildWindows) /* 12 */
#endif
...
#define Blt_NewStripeBrush \
	(bltTkIntProcsPtr->blt_NewStripeBrush) /* 69 */
#endif
#ifndef Blt_NewCheckerBrush
#define Blt_NewCheckerBrush \
	(bltTkIntProcsPtr->blt_NewCheckerBrush) /* 70 */
#endif
...
#define Blt_GetBrushType \
	(bltTkIntProcsPtr->blt_GetBrushType) /* 74 */
#endif
...
#define Blt_GetBrushColor \
	(bltTkIntProcsPtr->blt_GetBrushColor) /* 76 */
#endif
...
#define Blt_SetBrushRegion \
	(bltTkIntProcsPtr->blt_SetBrushRegion) /* 89 */
#endif
...
#define Blt_ComputeTextLayout \
	(bltTkIntProcsPtr->blt_ComputeTextLayout) /* 228 */
#endif
#ifndef Blt_DrawTextLayout
#define Blt_DrawTextLayout \
	(bltTkIntProcsPtr->blt_DrawTextLayout) /* 229 */
#endif
#ifndef Blt_CharBbox
#define Blt_CharBbox \
	(bltTkIntProcsPtr->blt_CharBbox) /* 230 */
#endif
#ifndef Blt_UnderlineTextLayout
#define Blt_UnderlineTextLayout \
	(bltTkIntProcsPtr->blt_UnderlineTextLayout) /* 231 */
#endif
#ifndef Blt_Ts_UnderlineLayout
#define Blt_Ts_UnderlineLayout \
	(bltTkIntProcsPtr->blt_Ts_UnderlineLayout) /* 232 */
#endif
#ifndef Blt_Ts_DrawText
#define Blt_Ts_DrawText \
	(bltTkIntProcsPtr->blt_Ts_DrawText) /* 233 */
#endif
#ifndef Blt_MeasureText
#define Blt_MeasureText \
	(bltTkIntProcsPtr->blt_MeasureText) /* 234 */
#endif
#ifndef Blt_FreeTextLayout
#define Blt_FreeTextLayout \
	(bltTkIntProcsPtr->blt_FreeTextLayout) /* 235 */
#endif
