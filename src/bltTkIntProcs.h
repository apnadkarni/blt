...
#endif
#ifndef Blt_Ps_DBuffer_DECLARED
#define Blt_Ps_DBuffer_DECLARED
/* 136 */
...
typedef struct BltTkIntProcs {
    ...
    Blt_PaintBrush * (*blt_Bg_PaintBrush) (Blt_Bg bg); /* 69 */
    const char * (*blt_Bg_Name) (Blt_Bg bg); /* 70 */
    void (*blt_FreeBg) (Blt_Bg bg); /* 71 */
    void (*blt_Bg_DrawRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 72 */
    void (*blt_Bg_FillRectangle) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, int x, int y, int width, int height, int borderWidth, int relief); /* 73 */
    void (*blt_Bg_DrawPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 74 */
    void (*blt_Bg_FillPolygon) (Tk_Window tkwin, Drawable drawable, Blt_Bg bg, XPoint *points, int numPoints, int borderWidth, int leftRelief); /* 75 */
    void (*blt_Bg_GetOrigin) (Blt_Bg bg, int *xPtr, int *yPtr); /* 76 */
    void (*blt_Bg_SetChangedProc) (Blt_Bg bg, Blt_Bg_ChangedProc *notifyProc, ClientData clientData); /* 77 */
    void (*blt_Bg_SetOrigin) (Tk_Window tkwin, Blt_Bg bg, int x, int y); /* 78 */
    void (*blt_Bg_DrawFocus) (Tk_Window tkwin, Blt_Bg bg, int highlightWidth, Drawable drawable); /* 79 */
    GC (*blt_Bg_BorderGC) (Tk_Window tkwin, Blt_Bg bg, int which); /* 80 */
    void (*blt_Bg_SetFromBackground) (Tk_Window tkwin, Blt_Bg bg); /* 81 */
    void (*blt_Bg_UnsetClipRegion) (Tk_Window tkwin, Blt_Bg bg); /* 82 */
    void (*blt_Bg_SetClipRegion) (Tk_Window tkwin, Blt_Bg bg, TkRegion rgn); /* 83 */
    void (*blt_DestroyBindingTable) (Blt_BindTable table); /* 84 */
    Blt_BindTable (*blt_CreateBindingTable) (Tcl_Interp *interp, Tk_Window tkwin, ClientData clientData, Blt_BindPickProc *pickProc, Blt_BindAppendTagsProc *tagProc); /* 85 */
    int (*blt_ConfigureBindings) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int argc, const char **argv); /* 86 */
    int (*blt_ConfigureBindingsFromObj) (Tcl_Interp *interp, Blt_BindTable table, ClientData item, int objc, Tcl_Obj *const *objv); /* 87 */
    void (*blt_PickCurrentItem) (Blt_BindTable table); /* 88 */
    void (*blt_DeleteBindings) (Blt_BindTable table, ClientData object); /* 89 */
    void (*blt_MoveBindingTable) (Blt_BindTable table, Tk_Window tkwin); /* 90 */
    void (*blt_Afm_SetPrinting) (Tcl_Interp *interp, int value); /* 91 */
    int (*blt_Afm_IsPrinting) (void); /* 92 */
    int (*blt_Afm_TextWidth) (Blt_Font font, const char *s, int numBytes); /* 93 */
    int (*blt_Afm_GetMetrics) (Blt_Font font, Blt_FontMetrics *fmPtr); /* 94 */
    const char * (*blt_Afm_GetPostscriptFamily) (const char *family); /* 95 */
    void (*blt_Afm_GetPostscriptName) (const char *family, int flags, Tcl_DString *resultPtr); /* 96 */
    void (*blt_SetDashes) (Display *display, GC gc, Blt_Dashes *dashesPtr); /* 97 */
    void (*blt_ResetLimits) (Blt_Limits *limitsPtr); /* 98 */
    int (*blt_GetLimitsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Limits *limitsPtr); /* 99 */
    int (*blt_ConfigureInfoFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 100 */
    int (*blt_ConfigureValueFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, char *widgRec, Tcl_Obj *objPtr, int flags); /* 101 */
    int (*blt_ConfigureWidgetFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 102 */
    int (*blt_ConfigureComponentFromObj) (Tcl_Interp *interp, Tk_Window tkwin, const char *name, const char *className, Blt_ConfigSpec *specs, int objc, Tcl_Obj *const *objv, char *widgRec, int flags); /* 103 */
    int (*blt_ConfigModified) (Blt_ConfigSpec *specs, ...); /* 104 */
    const char * (*blt_NameOfState) (int state); /* 105 */
    void (*blt_FreeOptions) (Blt_ConfigSpec *specs, char *widgRec, Display *display, int needFlags); /* 106 */
    int (*blt_ObjIsOption) (Blt_ConfigSpec *specs, Tcl_Obj *objPtr, int flags); /* 107 */
    int (*blt_GetPixelsFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, int flags, int *valuePtr); /* 108 */
    int (*blt_GetPadFromObj) (Tcl_Interp *interp, Tk_Window tkwin, Tcl_Obj *objPtr, Blt_Pad *padPtr); /* 109 */
    int (*blt_GetStateFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *statePtr); /* 110 */
    int (*blt_GetFillFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 111 */
    int (*blt_GetResizeFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *fillPtr); /* 112 */
    int (*blt_GetDashesFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_Dashes *dashesPtr); /* 113 */
    int (*blt_Image_IsDeleted) (Tk_Image tkImage); /* 114 */
    Tk_ImageMaster (*blt_Image_GetMaster) (Tk_Image tkImage); /* 115 */
    Tk_ImageType * (*blt_Image_GetType) (Tk_Image tkImage); /* 116 */
    ClientData (*blt_Image_GetInstanceData) (Tk_Image tkImage); /* 117 */
    const char * (*blt_Image_Name) (Tk_Image tkImage); /* 118 */
    const char * (*blt_Image_NameOfType) (Tk_Image tkImage); /* 119 */
    void (*blt_FreePainter) (Blt_Painter painter); /* 120 */
    Blt_Painter (*blt_GetPainter) (Tk_Window tkwin, float gamma); /* 121 */
    Blt_Painter (*blt_GetPainterFromDrawable) (Display *display, Drawable drawable, float gamma); /* 122 */
    GC (*blt_PainterGC) (Blt_Painter painter); /* 123 */
    int (*blt_PainterDepth) (Blt_Painter painter); /* 124 */
    int (*blt_PaintPicture) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 125 */
    int (*blt_PaintPictureWithBlend) (Blt_Painter painter, Drawable drawable, Blt_Picture src, int srcX, int srcY, int width, int height, int destX, int destY, unsigned int flags); /* 126 */
    Blt_Picture (*blt_PaintCheckbox) (int width, int height, XColor *fillColor, XColor *outlineColor, XColor *checkColor, int isOn); /* 127 */
    Blt_Picture (*blt_PaintRadioButton) (int width, int height, Blt_Bg bg, XColor *fill, XColor *outline, int isOn); /* 128 */
    Blt_Picture (*blt_PaintRadioButtonOld) (int width, int height, XColor *bg, XColor *fill, XColor *outline, XColor *check, int isOn); /* 129 */
    Blt_Picture (*blt_PaintDelete) (int width, int height, XColor *bgColor, XColor *fillColor, XColor *symColor, int isActive); /* 130 */
    Blt_Ps (*blt_Ps_Create) (Tcl_Interp *interp, PageSetup *setupPtr); /* 131 */
    void (*blt_Ps_Free) (Blt_Ps ps); /* 132 */
    const char * (*blt_Ps_GetValue) (Blt_Ps ps, int *lengthPtr); /* 133 */
    Blt_DBuffer (*blt_Ps_GetDBuffer) (Blt_Ps ps); /* 134 */
    Tcl_Interp * (*blt_Ps_GetInterp) (Blt_Ps ps); /* 135 */
    Blt_DBuffer (*blt_Ps_DBuffer) (Blt_Ps ps); /* 136 */
