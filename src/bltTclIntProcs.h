...
typedef struct BltTclIntProcs {
    ...
    Tcl_Obj * (*blt_DBuffer_Base64EncodeToObj) (Blt_DBuffer buffer); /* 21 */
    int (*blt_DBuffer_AppendBase85) (Blt_DBuffer buffer, const unsigned char *bytes, size_t numBytes); /* 22 */
    int (*blt_DBuffer_AppendBase64) (Blt_DBuffer buffer, const unsigned char *bytes, size_t numBytes); /* 23 */
    ...
    VOID * (*blt_ReallocAbortOnError) (VOID *ptr, size_t size, const char *file, int line); /* 31 */
    char * (*blt_StrdupAbortOnError) (const char *ptr, const char *file, int line); /* 32 */
    int (*blt_DictionaryCompare) (const char *s1, const char *s2); /* 33 */
    Blt_Uid (*blt_GetUid) (const char *string); /* 34 */
    void (*blt_FreeUid) (Blt_Uid uid); /* 35 */
    Blt_Uid (*blt_FindUid) (const char *string); /* 36 */
    int (*blt_CreatePipeline) (Tcl_Interp *interp, int objc, Tcl_Obj *const *objv, Blt_Pid **pidArrayPtr, int *stdinPipePtr, int *stdoutPipePtr, int *stderrPipePtr); /* 37 */
    void (*blt_InitHexTable) (unsigned char *table); /* 38 */
    void (*blt_DStringAppendElements) (Tcl_DString *dsPtr, ...); /* 39 */
    int (*blt_LoadLibrary) (Tcl_Interp *interp, const char *libPath, const char *initProcName, const char *safeProcName); /* 40 */
    void (*blt_Panic) (const char *fmt, ...); /* 41 */
    void (*blt_Warn) (const char *fmt, ...); /* 42 */
    int (*blt_GetSideFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *sidePtr); /* 43 */
    const char * (*blt_NameOfSide) (int side); /* 44 */
    FILE * (*blt_OpenFile) (Tcl_Interp *interp, const char *fileName, const char *mode); /* 45 */
    int (*blt_ExprDoubleFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, double *valuePtr); /* 46 */
    int (*blt_ExprIntFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int *valuePtr); /* 47 */
    const char * (*blt_Itoa) (int value); /* 48 */
    const char * (*blt_Ltoa) (long value); /* 49 */
    const char * (*blt_Utoa) (unsigned int value); /* 50 */
    const char * (*blt_Dtoa) (Tcl_Interp *interp, double value); /* 51 */
    unsigned char * (*blt_Base64_Decode) (Tcl_Interp *interp, const char *string, size_t *lengthPtr); /* 52 */
    Blt_DBuffer (*blt_Base64_DecodeToBuffer) (Tcl_Interp *interp, const char *string, size_t length); /* 53 */
    Tcl_Obj * (*blt_Base64_DecodeToObj) (Tcl_Interp *interp, const char *string, size_t length); /* 54 */
    Tcl_Obj * (*blt_Base64_EncodeToObj) (const unsigned char *buffer, size_t bufsize); /* 55 */
    size_t (*blt_Base64_MaxBufferLength) (size_t bufsize); /* 56 */
    size_t (*blt_Base64_Encode) (const unsigned char *buffer, size_t bufsize, unsigned char *destBytes); /* 57 */
    size_t (*blt_Base85_MaxBufferLength) (size_t bufsize); /* 58 */
    size_t (*blt_Base85_Encode) (const unsigned char *buffer, size_t bufsize, unsigned char *destBytes); /* 59 */
    const char * (*blt_Base16_Encode) (const unsigned char *buffer, size_t bufsize); /* 60 */
    int (*blt_IsBase64) (const char *buf, size_t length); /* 61 */
    int (*blt_GetDoubleFromString) (Tcl_Interp *interp, const char *s, double *valuePtr); /* 62 */
    int (*blt_GetDoubleFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, double *valuePtr); /* 63 */
    int (*blt_GetTimeFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, double *valuePtr); /* 64 */
    int (*blt_GetTime) (Tcl_Interp *interp, const char *string, double *valuePtr); /* 65 */
    int (*blt_GetDateFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, double *timePtr); /* 66 */
    int (*blt_GetDate) (Tcl_Interp *interp, const char *string, double *timePtr); /* 67 */
    int (*blt_GetPositionFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, long *indexPtr); /* 68 */
    int (*blt_GetCountFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, int check, long *valuePtr); /* 69 */
    int (*blt_SimplifyLine) (Point2d *origPts, int low, int high, double tolerance, int *indices); /* 70 */
    int (*blt_GetLong) (Tcl_Interp *interp, const char *s, long *longPtr); /* 71 */
    int (*blt_GetLongFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, long *longPtr); /* 72 */
    int (*blt_FormatString) (char *s, size_t size, const char *fmt, ...); /* 73 */
    void (*blt_LowerCase) (char *s); /* 74 */
    int (*blt_GetPlatformId) (void); /* 75 */
    const char * (*blt_LastError) (void); /* 76 */
    double (*blt_NaN) (void); /* 77 */
    int (*blt_AlmostEquals) (double x, double y); /* 78 */
    int (*blt_GetArrayFromObj) (Tcl_Interp *interp, Tcl_Obj *objPtr, Blt_HashTable **tablePtrPtr); /* 79 */
    Tcl_Obj * (*blt_NewArrayObj) (int objc, Tcl_Obj *objv[]); /* 80 */
    void (*blt_RegisterArrayObj) (void); /* 81 */
    int (*blt_IsArrayObj) (Tcl_Obj *obj); /* 82 */
    void (*blt_Assert) (const char *expr, const char *file, int line); /* 83 */
    int (*blt_InitCmd) (Tcl_Interp *interp, const char *namespace, Blt_CmdSpec *specPtr); /* 84 */
    int (*blt_InitCmds) (Tcl_Interp *interp, const char *namespace, Blt_CmdSpec *specPtr, int numCmds); /* 85 */
    VOID * (*blt_GetOpFromObj) (Tcl_Interp *interp, int numSpecs, Blt_OpSpec *specs, int operPos, int objc, Tcl_Obj *const *objv, int flags); /* 86 */
    Tcl_Namespace * (*blt_GetVariableNamespace) (Tcl_Interp *interp, const char *varName); /* 87 */
    Tcl_Namespace * (*blt_GetCommandNamespace) (Tcl_Command cmdToken); /* 88 */
    Tcl_CallFrame * (*blt_EnterNamespace) (Tcl_Interp *interp, Tcl_Namespace *nsPtr); /* 89 */
    void (*blt_LeaveNamespace) (Tcl_Interp *interp, Tcl_CallFrame *framePtr); /* 90 */
    int (*blt_ParseObjectName) (Tcl_Interp *interp, const char *name, Blt_ObjectName *objNamePtr, unsigned int flags); /* 91 */
    const char * (*blt_MakeQualifiedName) (Blt_ObjectName *objNamePtr, Tcl_DString *resultPtr); /* 92 */
    int (*blt_CommandExists) (Tcl_Interp *interp, const char *string); /* 93 */
    Blt_Spline (*blt_CreateSpline) (Point2d *points, int n, int type); /* 94 */
    Point2d (*blt_EvaluateSpline) (Blt_Spline spline, int index, double x); /* 95 */
    void (*blt_FreeSpline) (Blt_Spline spline); /* 96 */
    Blt_Spline (*blt_CreateParametricCubicSpline) (Point2d *points, int n, int w, int h); /* 97 */
    Point2d (*blt_EvaluateParametricCubicSpline) (Blt_Spline spline, int index, double x); /* 98 */
    void (*blt_FreeParametricCubicSpline) (Blt_Spline spline); /* 99 */
    Blt_Spline (*blt_CreateCatromSpline) (Point2d *points, int n); /* 100 */
    Point2d (*blt_EvaluateCatromSpline) (Blt_Spline spline, int i, double t); /* 101 */
    void (*blt_FreeCatromSpline) (Blt_Spline spline); /* 102 */
    int (*blt_ComputeNaturalSpline) (Point2d *origPts, int numOrigPts, Point2d *intpPts, int numIntpPts); /* 103 */
    int (*blt_ComputeQuadraticSpline) (Point2d *origPts, int numOrigPts, Point2d *intpPts, int numIntpPts); /* 104 */
    int (*blt_ComputeNaturalParametricSpline) (Point2d *origPts, int numOrigPts, Region2d *extsPtr, int isClosed, Point2d *intpPts, int numIntpPts); /* 105 */
    int (*blt_ComputeCatromParametricSpline) (Point2d *origPts, int numOrigPts, Point2d *intpPts, int numIntpPts); /* 106 */
    int (*blt_ParseSwitches) (Tcl_Interp *interp, Blt_SwitchSpec *specPtr, int objc, Tcl_Obj *const *objv, VOID *rec, int flags); /* 107 */
    void (*blt_FreeSwitches) (Blt_SwitchSpec *specs, VOID *rec, int flags); /* 108 */
    int (*blt_SwitchChanged) (Blt_SwitchSpec *specs, ...); /* 109 */
    int (*blt_SwitchInfo) (Tcl_Interp *interp, Blt_SwitchSpec *specs, VOID *record, Tcl_Obj *objPtr, int flags); /* 110 */
    int (*blt_SwitchValue) (Tcl_Interp *interp, Blt_SwitchSpec *specs, VOID *record, Tcl_Obj *objPtr, int flags); /* 111 */
    Tcl_Var (*blt_GetCachedVar) (Blt_HashTable *tablePtr, const char *label, Tcl_Obj *objPtr); /* 112 */
    void (*blt_FreeCachedVars) (Blt_HashTable *tablePtr); /* 113 */
} BltTclIntProcs;
