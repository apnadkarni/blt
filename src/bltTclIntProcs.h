...
BLT_EXTERN int		Blt_CreatePipeline(Tcl_Interp *interp, int objc,
				...
				int *stdinPipePtr, int *stdoutPipePtr,
                                int *stderrPipePtr, const char *env);
#endif
...
typedef struct BltTclIntProcs {
    ...
    int (*blt_CreatePipeline) (Tcl_Interp *interp, int objc, Tcl_Obj *const *objv, Blt_Pid **pidArrayPtr, int *stdinPipePtr, int *stdoutPipePtr, int *stderrPipePtr, const char *env); /* 88 */
