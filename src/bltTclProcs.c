...
BltTclProcs bltTclProcs = {
    ...
    blt_table_set_int64, /* 178 */
    blt_table_get_int64, /* 179 */
    blt_table_get_value, /* 180 */
    blt_table_set_value, /* 181 */
    blt_table_unset_value, /* 182 */
    blt_table_value_exists, /* 183 */
    blt_table_value_string, /* 184 */
    blt_table_value_bytes, /* 185 */
    blt_table_value_length, /* 186 */
    blt_table_tags_are_shared, /* 187 */
    blt_table_clear_row_tags, /* 188 */
    blt_table_clear_column_tags, /* 189 */
    blt_table_get_row_tags, /* 190 */
    blt_table_get_column_tags, /* 191 */
    blt_table_get_tagged_rows, /* 192 */
    blt_table_get_tagged_columns, /* 193 */
    blt_table_row_has_tag, /* 194 */
    blt_table_column_has_tag, /* 195 */
    blt_table_forget_row_tag, /* 196 */
    blt_table_forget_column_tag, /* 197 */
    blt_table_unset_row_tag, /* 198 */
    blt_table_unset_column_tag, /* 199 */
    blt_table_first_column, /* 200 */
    blt_table_last_column, /* 201 */
    blt_table_next_column, /* 202 */
    blt_table_previous_column, /* 203 */
    blt_table_first_row, /* 204 */
    blt_table_last_row, /* 205 */
    blt_table_next_row, /* 206 */
    blt_table_previous_row, /* 207 */
    blt_table_row_spec, /* 208 */
    blt_table_column_spec, /* 209 */
    blt_table_iterate_rows, /* 210 */
    blt_table_iterate_columns, /* 211 */
    blt_table_iterate_rows_objv, /* 212 */
    blt_table_iterate_columns_objv, /* 213 */
    blt_table_free_iterator_objv, /* 214 */
    blt_table_iterate_all_rows, /* 215 */
    blt_table_iterate_all_columns, /* 216 */
    blt_table_first_tagged_row, /* 217 */
    blt_table_first_tagged_column, /* 218 */
    blt_table_next_tagged_row, /* 219 */
    blt_table_next_tagged_column, /* 220 */
    blt_table_list_rows, /* 221 */
    blt_table_list_columns, /* 222 */
    blt_table_clear_row_traces, /* 223 */
    blt_table_clear_column_traces, /* 224 */
    blt_table_create_trace, /* 225 */
    blt_table_trace_column, /* 226 */
    blt_table_trace_row, /* 227 */
    blt_table_create_column_trace, /* 228 */
    blt_table_create_column_tag_trace, /* 229 */
    blt_table_create_row_trace, /* 230 */
    blt_table_create_row_tag_trace, /* 231 */
    blt_table_delete_trace, /* 232 */
    blt_table_create_notifier, /* 233 */
    blt_table_create_row_notifier, /* 234 */
    blt_table_create_row_tag_notifier, /* 235 */
    blt_table_create_column_notifier, /* 236 */
    blt_table_create_column_tag_notifier, /* 237 */
    blt_table_delete_notifier, /* 238 */
    blt_table_sort_init, /* 239 */
    blt_table_sort_rows, /* 240 */
    blt_table_sort_row_map, /* 241 */
    blt_table_sort_finish, /* 242 */
    blt_table_get_compare_proc, /* 243 */
    blt_table_get_row_map, /* 244 */
    blt_table_get_column_map, /* 245 */
    blt_table_set_row_map, /* 246 */
    blt_table_set_column_map, /* 247 */
    blt_table_restore, /* 248 */
    blt_table_file_restore, /* 249 */
    blt_table_register_format, /* 250 */
    blt_table_unset_keys, /* 251 */
    blt_table_get_keys, /* 252 */
    blt_table_set_keys, /* 253 */
    blt_table_key_lookup, /* 254 */
    blt_table_get_column_limits, /* 255 */
    blt_table_row, /* 256 */
    blt_table_column, /* 257 */
    blt_table_row_index, /* 258 */
    blt_table_column_index, /* 259 */
    Blt_VecMin, /* 260 */
    Blt_VecMax, /* 261 */
    Blt_AllocVectorId, /* 262 */
    Blt_SetVectorChangedProc, /* 263 */
    Blt_FreeVectorId, /* 264 */
    Blt_GetVectorById, /* 265 */
    Blt_NameOfVectorId, /* 266 */
    Blt_NameOfVector, /* 267 */
    Blt_VectorNotifyPending, /* 268 */
    Blt_CreateVector, /* 269 */
    Blt_CreateVector2, /* 270 */
    Blt_GetVector, /* 271 */
    Blt_GetVectorFromObj, /* 272 */
    Blt_VectorExists, /* 273 */
    Blt_ResetVector, /* 274 */
    Blt_ResizeVector, /* 275 */
    Blt_DeleteVectorByName, /* 276 */
    Blt_DeleteVector, /* 277 */
    Blt_ExprVector, /* 278 */
    Blt_InstallIndexProc, /* 279 */
    Blt_VectorExists2, /* 280 */
};
