...
/* Define to 1 if you have the declaration of `XRRGetScreenResources', and to
   0 if you don't. */
#define HAVE_DECL_XRRGETSCREENRESOURCES 0
...
/* Define to 1 if you have the `SQLITE' library (-lsqlite3). */
